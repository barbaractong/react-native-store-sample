...
export default function Home({navigation}) {
  ...
  function getLocation(ADDRESS) {
    const LOCATION_FROM_API = getLocationCoord.decodeUrlParameter(ADDRESS);
  ...
  }, [addressInput, geolocationLink, responseData, setCoordinates]);
      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style={styles.container}>
          <View style={styles.top}>
            <Image style={styles.imageTop} source={ICON_HOME} />
          </View>
